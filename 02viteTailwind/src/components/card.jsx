...
function card({ headTitle, btn = "Visit Me", view }) {
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group mb-2 ">
      <div className="relative overflow-hidden rounded-lg mb-6">
        <img
          src="https://images.pexels.com/photos/34627919/pexels-photo-34627919.jpeg"
          alt=""
          width={400}
          height={300}
